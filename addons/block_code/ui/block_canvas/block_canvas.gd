...
const BlockNameTree = preload("res://addons/block_code/serialization/block_name_tree.gd")
const BlockNameTreeNode = preload("res://addons/block_code/serialization/block_name_tree_node.gd")
const ValueBlockNameTreeNode = preload("res://addons/block_code/serialization/value_block_name_tree_node.gd")
...
func _load_block_script(block_script: BlockScriptSerialization):
	...
	for name_tree in block_script.block_name_trees:
...
func rebuild_block_name_trees():
	...
	_current_block_script.block_name_trees = new_block_name_trees


func build_block_name_tree(ast_node: BlockAST.ASTNode) -> BlockNameTreeNode:
	var block_name_tree_node := BlockNameTreeNode.new(ast_node.data.name)
...
func build_block_value_name_tree(ast_node: BlockAST.ASTValueNode) -> ValueBlockNameTreeNode:
	var block_name_tree_node := ValueBlockNameTreeNode.new(ast_node.data.name)

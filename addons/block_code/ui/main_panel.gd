...
func save_script():
	...
	undo_redo.add_undo_property(block_script, "block_name_trees", block_script.block_name_trees)
	_block_canvas.rebuild_ast_list()
	_block_canvas.rebuild_block_name_trees()
	undo_redo.add_do_property(block_script, "block_name_trees", block_script.block_name_trees)
